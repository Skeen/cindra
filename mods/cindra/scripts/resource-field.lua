...
-- 200 to 50 tiles and the tile-boundary bleed shrank with the noise amplitudes), so
-- the pull-back stays a small fraction of the building band rather than swallowing it.
