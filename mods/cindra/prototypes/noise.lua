...
-- 128-tile functional ribbon has no room for cliffs -- a cliff walls the narrow
-- traversable band, and the engine strips any placed in it -- so the cliff field is
-- gone and the ribbon is flat/cliff-free. (terrain.cliff_band survives only as the
-- volcanic-tile band geometry the burned-rock autoplace reads, not a cliff driver.)
--
