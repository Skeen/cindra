local s = require '__factorio-test__.say'
local astate = require '__factorio-test__.luassert.state'
local util = require '__factorio-test__.luassert.util'
local unpack = util.unpack
local obj   -- the returned module table
local level_mt = {}

-- list of namespaces
local namespace = require '__factorio-test__.luassert.namespaces'
