...
--     tiles burn everything on them, player + machines), the full-screen heat/cold
--     feedback tint that rides the SAME tick so it tracks that damage (ci-7tl),
--     and the nightside building-heat freeze. The RIBBON ITSELF (finite width, noise tile bands,
