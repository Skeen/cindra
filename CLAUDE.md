...
**YOU ARE IN: `cindra/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cindra/` (rig root) or other directories
...
**Your mail address:** `cindra/polecats/guzzle`
**Your rig:** cindra
**Your Witness:** `cindra/witness`
...
| Ask Witness for help | `gt mail send cindra/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cindra/witness`) when:
...
```bash
gt mail send cindra/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
