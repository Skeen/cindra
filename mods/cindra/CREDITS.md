...
The lava-manufacturer (stone->lava melter) building + icon graphics are the
"glass-furnace" set, and the electrolysis-cell (signature aluminium building) +
...
See `graphics/entity/lava-manufacturer/ATTRIBUTION.md`,
`graphics/entity/electrolysis-cell/ATTRIBUTION.md`, and
`graphics/entity/arc-furnace/ATTRIBUTION.md` for the per-asset records.
